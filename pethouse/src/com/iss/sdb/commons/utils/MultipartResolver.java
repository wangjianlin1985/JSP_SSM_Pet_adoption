...
public class MultipartResolver extends CommonsMultipartResolver {
    ...
    public List<FileUpResModel> upload(HttpServletRequest request, String path) throws IOException {
        ...
        this.setServletContext(request.getSession().getServletContext());
            ...
            while (itor.hasNext()) {
                ...
                if (file != null) {
                    ...
                    if (StringUtils.isNotBlank(originalFileName)) {
                        ...
                        //request.getServletContext().getRealPath(newFileName) 需要servlet3.0规范才行
                        localFile = new File(request.getRealPath(newFileName));
                        file.transferTo(localFile);

                        //newFileName = StringUtils.substringAfterLast(newFileName, appPath);
                        newFileName = StringUtils.substringAfter(newFileName, appPath);
